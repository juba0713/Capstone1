...
//			+ "AND a.delete_flg = false";
	...
	public final String GET_APPLICANT_DETAILS_WITH_FEEDBACKS = "SELECT  "
			...
			+ "    d.ct_nine_comments, "
			+ "	d.recommendation, "
			+ "    COALESCE(ed.ct_one_rating, 0), "
			+ "    ed.ct_one_comments, "
			+ "    COALESCE(ed.ct_two_rating, 0), "
			+ "    ed.ct_two_comments, "
			+ "    COALESCE(ed.ct_three_rating,0), "
			+ "    ed.ct_three_comments, "
			+ "    COALESCE(ed.ct_four_rating,0), "
			+ "    ed.ct_four_comments, "
			+ "    COALESCE(ed.ct_five_rating,0), "
			+ "    ed.ct_five_comments, "
			+ "    COALESCE(ed.ct_six_rating,0), "
			+ "    ed.ct_six_comments, "
			+ "    COALESCE(ed.ct_seven_rating,0), "
			+ "    ed.ct_seven_comments, "
			+ "   COALESCE( ed.ct_eight_rating,0), "
