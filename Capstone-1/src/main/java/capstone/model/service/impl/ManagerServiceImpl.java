...
public class ManagerServiceImpl implements ManagerService {
	...
	public ManagerInOutDto activateApplicantAccount(ManagerInOutDto inDto) throws MessagingException {
		...
		emailService.sendActivationMail(randomPassword,
	...
	public ManagerInOutDto getAppllicantRankingByYearMonth(ManagerInOutDto inDto) throws Exception {
		...
		List<ApplicantMonthly> applicants = applicantLogic.getApplicantRankingByYearMonth(inDto.getMonth(),
				inDto.getYear());
	...
	public ManagerInOutDto getHistoryApplicantDetails(ManagerInOutDto inDto) {
		...
		List<HistoryApplicantDetailsEntity> applicant = applicantLogic
				.getHistoryApplicantDetailsByIdPk(inDto.getApplicantIdPk(), inDto.getProjectIdPk());
